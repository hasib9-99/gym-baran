  ...
  return (
    <section className="mt-20">
        <div className="container flex items-center justify-between relative">
            <div className="w-1/2">
                <h2 className="text-6xl font-Grotesque font-bold">Healthy in side <br/><span className="font-Grotesque font-bold text-secondary">fresh</span> out side</h2>
                ...
                <div className="pb-14">
                    <a className="pimary-btn py-3 px-6"href="#">Get started <i class="ml-16 px-1 py-px rounded-full bg-white fa-solid text-primary fa-angle-right"></i></a>
